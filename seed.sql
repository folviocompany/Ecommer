...
INSERT INTO variations (product_id, size, color, color_hex, stock, price_modifier, active) VALUES
  ...
  (1, 'G',  'Cinza',  '#808080', 0,  0, true),
  (1, 'GG', 'Cinza',  '#808080', 2,  0, true);

-- Camiseta Acid Wash (id=2)
INSERT INTO variations (product_id, size, color, color_hex, stock, price_modifier, active) VALUES
...
-- =============================================================
-- UPDATE de imagens — executar se o banco já foi seedado
-- (atualiza URLs de w=800 para w=600)
-- =============================================================
UPDATE products SET images = ARRAY['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&q=80','https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=600&q=80'] WHERE slug = 'camiseta-urban-flow';
